...
export default function Contact({ onCopyEmail, onShowToast }) {
  ...
  const MAKE_WEBHOOK_URL =
    'https://hook.us2.make.com/riui7q2tuufpqx3fnjoc1lis3m9be4kn';
      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-intro">
            Interested in discussing an internship, project
            collaboration, or technical opportunity? Feel free
            to reach out directly or send a message below.
          </p>
        </div>
          ...
          <div className="contact-form-container">
            <div className="form-header">
              ...
              <p className="form-description">
                Have a question or opportunity? Drop me a message
            ...
            >
              ...
              <p className="form-note">
                ...
                <span>
                  Your message will be securely submitted through
                  the contact form.
                </span>
              </p>
            </form>
